(function($) { "use strict";
	...
	let introtitle = document.getElementsByClassName("introtitle");
	const arr = Array.from(introtitle);
	const fontFamilies = ["'Plus Jakarta Sans', sans-serif", "'Roboto Mono', monospace", "'Jura', sans-serif", "'Josefin Slab', serif"];
	let fontIndex = 0;
	...
	window.addEventListener("mousemove", (e) => {
		...
		arr.forEach(function (text) {
			text.style.willChange = "font-variation-settings";
			text.style.fontVariationSettings = '"wght"' + scale(xPos, 0, innerWidth, 200, 800);
			// text.style.fontWeight = scale(xPos, 0, innerWidth, 200, 800);
			text.style.transform = "skew(" + scale(yPos, 0, innerHeight, 0, -40) + "deg)";
		});
	})
	...
	setInterval(() => {
		let newFont = fontFamilies[fontIndex++ % fontFamilies.length];
		arr.forEach(function (text) {
